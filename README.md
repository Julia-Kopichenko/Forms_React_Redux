# Forms_React_Redux
Делаем сложную форму регистрации человека на гипотетическом сервисе.
...
o Номер телефона своего парня в международном формате (валидация). 

Если номер не белорусский - следующее поле делаем disable, автоматом выбираем tefal
· Сковороду какой фирмы предпочитаешь (дропдаун с фильтром)

Шаг второй - Ввести данные кредитной карточки. 
